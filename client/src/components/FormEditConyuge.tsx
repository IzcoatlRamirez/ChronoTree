...
import UploadFileConyuge from "./UploadFileConyuge";
...
import { uploadNodeConyuge } from "../services/NodesService";

function FormEditConyuge({id,updateNodes,updateNodesConyuge}:NodeRoot) {
  ...
  const handleFormSubmit = async () => {
    try {
      const response = await uploadNodeConyuge(id,name,dateOfBirth,dateOfDeath,placeOfBirth);
  ...
  return (
    ...
    <div>
        <UploadFileConyuge id={id} updateNodes={updateNodes} updateNodesConyuge={updateNodesConyuge}/>        
    </div>
...
export default FormEditConyuge